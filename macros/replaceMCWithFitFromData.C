...
void replaceMCWithFitFromData( TString dataFileName = "", TString fitTypeName = "preFit", TString fitFileName = "mlfit.root", TString wsFileName = "wsTest.root", double scaleTTH=1.0 ) {
